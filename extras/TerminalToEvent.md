...
title: OctoPrint-PauseForUserEvent
description: Raises the event 'paused_for_user' when the printer sends the same via serial
...
http://plugins.octoprint.org/plugin/PauseForUserEvent/
